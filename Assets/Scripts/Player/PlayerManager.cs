...
public class PlayerManager : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        rb.velocity = p2    ? new Vector2(pi.GetHorizontalInputP2() * movementSpeed * movementSpeedMod *invert, rb.velocity.y) 
                            : new Vector2(pi.GetHorizontalInput() * movementSpeed * movementSpeedMod * invert, rb.velocity.y);
        ...
        timerFootstep = p2 ? pi.GetHorizontalInputP2() != 0 : pi.GetHorizontalInput() != 0;
    ...
    void Jump()
    {
        ...
        if (p2)
        {
            ...
            if ((pi.GetVerticalInputP2() > 0) && !stoppedJumping)
            {
